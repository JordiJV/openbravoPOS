...
public class JTicketsBagTicket extends JTicketsBag {
    ...
    public void activate() {
        ...
        m_jPrintInvoice.setVisible(m_App.getAppUserView().getUser().hasPermission("sales.PrintTicket"));
    ...
    private void printTicket() {
        ...
        m_jPrintInvoice.setEnabled(m_ticket != null);
    ...
    private void initComponents() {
        ...
        m_jPrintInvoice = new javax.swing.JButton();
        ...
        m_jPrintInvoice.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/yast_printer.png"))); // NOI18N
        m_jPrintInvoice.setText(AppLocal.getIntString("button.printInvoice")); // NOI18N
        m_jPrintInvoice.setFocusPainted(false);
        m_jPrintInvoice.setFocusable(false);
        m_jPrintInvoice.setMargin(new java.awt.Insets(8, 14, 8, 14));
        m_jPrintInvoice.setRequestFocusEnabled(false);
        m_jPrintInvoice.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
            	m_jPrintInvoiceActionPerformed(evt);
            }
        });
        m_jButtons.add(m_jPrintInvoice);
    ...
    private void m_jPrintInvoiceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:m_jPrintInvoiceActionPerformed
        
        if (m_ticket != null) {
        		m_panelticketedit.printTicketInvoice(m_ticket, null);
                
                //m_App.getAppUserView().showTask("/com/openbravo/reports/customersb.bs"); 
        }  
...
private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
    ...
    private javax.swing.JButton m_jPrintInvoice;
