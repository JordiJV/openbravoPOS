...
public class JPaymentSelectCustomer extends JPaymentSelect {
    ...
    public static JPaymentSelect getDialog(Component parent) {
        ...
        JPaymentSelectCustomer myMsg;
        
        if (window instanceof Frame) { 
        	myMsg = new JPaymentSelectCustomer((Frame) window, true, parent.getComponentOrientation());
        } else {
        	myMsg = new JPaymentSelectCustomer((Dialog) window, true, parent.getComponentOrientation());
        } 
        
        if (!windowFitsOnScreen(myMsg)) centerWindowToScreen(myMsg);
