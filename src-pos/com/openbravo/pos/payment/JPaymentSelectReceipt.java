...
public class JPaymentSelectReceipt extends JPaymentSelect {
    ...
    public static JPaymentSelect getDialog(Component parent) {
        ...
        JPaymentSelectReceipt myMsg;
        if (window instanceof Frame) { 
        	myMsg = new JPaymentSelectReceipt((Frame) window, true, parent.getComponentOrientation());
        } else {
        	myMsg = new JPaymentSelectReceipt((Dialog) window, true, parent.getComponentOrientation());
        }
