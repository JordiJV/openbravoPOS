...
public class JPaymentSelectRefund extends JPaymentSelect {
    ...
    public static JPaymentSelect getDialog(Component parent) {
        ...
        JPaymentSelectRefund myMsg;
        if (window instanceof Frame) { 
        	myMsg = new JPaymentSelectRefund((Frame) window, true, parent.getComponentOrientation());
        } else {
        	myMsg = new JPaymentSelectRefund((Dialog) window, true, parent.getComponentOrientation());
        }
